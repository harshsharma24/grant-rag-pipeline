...
def store_grant_metadata(grant_data):
    ...
    grant_metadata = {
        ...
        "created_at": datetime.datetime.utcnow(),  # Timestamp when stored
        "updated_at": datetime.datetime.utcnow()  # Initially same as created_at
    }

    # Insert into MongoDB
    grants_collection.insert_one(grant_metadata)
